...
import com.lvhiei.mytestservice.glutil.GlUtil;
import com.lvhiei.mytestservice.glutil.OpenGLUtils;
import com.lvhiei.mytestservice.glutil.TextureRotationUtil;
...
//            "     gl_FragColor = vec4(1.0,0.0,0.0,1.0);\n" +
     ...
     */
    public void calculateVertexBuffer(int displayW, int displayH, int imageW, int imageH, boolean needClip) {
    ...
    public void setVertexBuffer(FloatBuffer vertexBuffer) {
        ...
        if(vertexBuffer.remaining() != mVertexBuffer.capacity()){
            return;
        }
    ...
    public int onDrawFrame(final int textureId) {
        ...
        GlUtil.checkGlError("onDrawFrame glUseProgram");
