...
struct AVApplicationContext {
    ...
    void (*func_on_connect)(AVApplicationContext *h, const char *ip, int dnsTime, int connectTimie);
    void (*func_on_recv_http)(AVApplicationContext *h, int recvTime);
};
...
//add by vvlive
void vv_application_on_connect(AVApplicationContext *h, const char *ip, int dnsTime, int connectTime);
void vv_application_on_recv_http(AVApplicationContext *h, int recvTime);
